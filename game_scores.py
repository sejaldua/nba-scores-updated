...
games = games[(games['SEASON_ID'].isin(['22023'])) & (games['GAME_ID'].str.startswith('00')) & (games['WL'].isin(['W', 'L']))]
...
merged = pd.merge(road, home, how='left', left_on=['GAME_ID'], right_on=['GAME_ID'])
